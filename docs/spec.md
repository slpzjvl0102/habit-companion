...
## 검증 가설 (실험)
유아가 아니라 10살 + '돌봄'이 아니라 '성장형 컴패니언'으로 리스킨됨. 가설: **아이가 컴패니언을 키우려는 동기 때문에 잔소리 없이 아침 습관(이불 정리)을 스스로 한다.** 성공 = 3주 후 아이가 스스로 주 5일+ & 부모가 '환경이 했다' 체감. 실패 = 여전히 매일 시켜야 함 / 컴패니언 흥미 상실.
